classdef Swirl
    ...
    methods
        ...
        function obj = advance(obj, dt)
            ...
            t  = obj.local_time;
            tf = obj.duration;
            if t < obj.rise_time                           % fade-in
                obj.life = flc2hs(t - obj.rise_time/2, obj.rise_time/2);
            elseif t < tf - obj.fall_time                  % plateau
                obj.life = 1;
            elseif t < tf                                  % fade-out
                tau      = tf - t;                         % time to end
                obj.life = flc2hs(tau - obj.fall_time/2, obj.fall_time/2);
            else                                           % expired
                obj.life = 0;
            end
        end

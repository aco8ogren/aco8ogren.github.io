 ...
 * @Last Modified time: 2025-08-22 17:08:37
 */
...
export class RectangularDomain extends Domain {
  ...
  hud_block(ctx = {}) {
    return `Domain: Rectangular
  L = [${this.L.x}, ${this.L.y}, ${this.L.z}]
  padding = [${this.padding_fraction.x}, ${this.padding_fraction.y}, ${this.padding_fraction.z}]`;
  }
}
